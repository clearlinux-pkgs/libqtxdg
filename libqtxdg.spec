...
Source0  : https://github.com/lxqt/libqtxdg/releases/download/3.7.0/libqtxdg-3.7.0.tar.xz
Source1  : https://github.com/lxqt/libqtxdg/releases/download/3.7.0/libqtxdg-3.7.0.tar.xz.asc
...
%prep
%setup -q -n libqtxdg-3.7.0
cd %{_builddir}/libqtxdg-3.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618504283
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libqtxdg-3.7.0/COPYING %{buildroot}/usr/share/package-licenses/libqtxdg/a222eb7a5344a5c487bd633a6eb5810028d5a74e
pushd clr-build
%make_install
popd
...
/usr/include/qt5xdgiconloader/3.7.0/private/xdgiconloader/xdgiconloader_p.h
...
/usr/lib64/libQt5Xdg.so.3.7.0
/usr/lib64/libQt5XdgIconLoader.so.3
/usr/lib64/libQt5XdgIconLoader.so.3.7.0
